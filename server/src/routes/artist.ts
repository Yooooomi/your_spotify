...
router.get('/:ids', validating(getArtistsSchema, 'params'), isLoggedOrGuest, async (req, res) => {
  try {
...
router.get('/search/:query', validating(search, 'params'), isLoggedOrGuest, async (req, res) => {
