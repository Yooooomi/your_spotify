...
export const login = myAsyncThunk<
  { username: string; password: string },
  User | null
>("@user/login", async ({ username, password }, tapi) => {
  try {
...
export const register = myAsyncThunk<
  { username: string; password: string },
  void
>("@user/register", async ({ username, password }, tapi) => {
  try {
...
export const checkLogged = myAsyncThunk<void, User | null>(
  "@user/checklogged",
  async () => {
    try {
...
export const changePasswordForAccountId = myAsyncThunk<
  { id: string; password: string },
  void
>("@user/change-password-account-id", async ({ id, password }, tapi) => {
  try {
