...
export default function AverageNumberArtistPer({ className }: AverageNumberArtistPerProps) {
  ...
  const tooltipValueFormatter = useCallback((value: number) => `${value} artists`, []);
